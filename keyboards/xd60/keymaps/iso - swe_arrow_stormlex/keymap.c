...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FL] = LAYOUT_ALL(
      ...
      KC_LSFT, RGB_TOG, RGB_MOD, KC_CUT,  KC_COPY,KC_PASTE,RGB_HUI,RGB_HUD,RGB_SAI,RGB_SAD,RGB_VAI,RGB_VAD, KC_HOME, KC_PGUP,   KC_INS, \
      KC_LGUI, KC_NO, KC_LALT,                          KC_SPC,                          KC_RALT, F(0),   KC_END,   KC_PGDOWN, KC_NO),
