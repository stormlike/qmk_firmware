...
[_MA] = LAYOUT_ISO( /* Base */
  ...
  KC_LCTRL, KC_LGUI,KC_LALT,                KC_SPC,                        KC_RALT,MO(_F1),KC_RCTRL,              KC_LEFT,KC_DOWN,KC_RGHT,    KC_P0,   KC_PDOT, KC_BSPC),
  
[_F1] = LAYOUT_ISO( /* Function Layer */
  KC_GRAVE,   KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11,  KC_F12,  KC_DEL, _______,		_______, _______, _______, _______,\
  ...
  _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______, _______,        _______,       _______,  	_______, _______, _______, _______,\
  _______, _______,KC_LGUI,                _______,                        _______,_______,_______,              _______,_______,_______,	_______, _______, _______),
